...
void log_help() {
    std::cout
        ...
        << std::endl
        << "  rosrun mech_lidar_driver mech_driver --lidar-ip 192.168.0.120"
        << " --set-config motor_speed 10" << std::endl
        << "  rosrun mech_lidar_driver mech_driver --set-config preemptive_conns"
        << " true" << std::endl
        << "  rosrun mech_lidar_driver mech_driver --set-config-json"
